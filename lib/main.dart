...
void main() {
  runApp(new MaterialApp(
    ...
    routes: <String, WidgetBuilder>{
      ...
      New_appointment.routeName: (BuildContext context) =>new New_appointment(),
      Upcoming_appointments.routeName: (BuildContext context) =>new Upcoming_appointments(),
      Appointment_history.routeName: (BuildContext context) =>new Appointment_history(),
    },
  ));
}
